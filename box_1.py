...
class Box_1():
    def __init__(self, map, background, surface, menu):
        ...
        self.map = map
        self.menu = menu
        self.menu.switch_image(right_box_1)

        self.itens = []
        self.itens.append( Image(surface, 'bike_exe_1/button 1.png', False, (170, 491)) )
        self.itens.append( Image(surface, 'bike_exe_1/button 2.png', False, (341, 491)) )
        self.itens.append( Image(surface, 'bike_exe_1/button 3.png', False, (254, 491)) )
        self.itens.append( Image(surface, 'bike_exe_1/button 4.png', False, (425, 491)) )
        self.itens.append( Image(surface, 'bike_exe_1/button ok.png', False, (700, 360)) )
        self.itens.append( Image(surface, 'bike_exe_1/button back.png', False, (691, 492)) )
        self.itens.append( Image(surface, 'bike_exe_1/help.png', False, (170, 393)))

        self.itens_changed = []
        self.itens_changed.append( Image(surface, 'bike_exe_1/x.png', False, (170, 491)) )
        self.itens_changed.append( Image(surface, 'bike_exe_1/x.png', False, (341, 491)) )
        self.itens_changed.append( Image(surface, 'bike_exe_1/x.png', False, (254, 491)) )
        self.itens_changed.append( Image(surface, 'bike_exe_1/x.png', False, (425, 491)) )

        self.itens_highlight = []
        self.itens_highlight.append( Image(surface, 'bike_exe_1/Highlight_button 1.png', False, (170, 491)) )
        self.itens_highlight.append( Image(surface, 'bike_exe_1/Highlight_button 2.png', False, (341, 491)) )
        self.itens_highlight.append( Image(surface, 'bike_exe_1/Highlight_button 3.png', False, (254, 491)) )
        self.itens_highlight.append( Image(surface, 'bike_exe_1/Highlight_button 4.png', False, (425, 491)) )

        self.help = Image(surface, 'bike_exe_1/balon_help.png', False)
    ...
    def exe_1(self):
        ...
        self.background.switch_image(exe_1_box)
        for x in self.itens:
            x.status = True
        ...
        if xy[1] > 491 and xy[1] < 540:
            ...
            if xy[0] > 254 and xy[0] < 330 and not 1 in self.choices:
                ...
                self.itens_highlight[2].status = False
                    ...
                    #Bicicleta
            if xy[0] > 341 and xy[0] < 416 and not 3 in self.choices:
                ...
                self.itens_highlight[1].status = False
                    ...
                    #Cadeado
            if xy[0] > 170 and xy[0] < 244 and not 2 in self.choices:
